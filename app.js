...
//connecting to db
mongoose.connect("mongodb+srv://soluwizy:xft4kcN0QVvOblp3@cluster0.x4sbgl2.mongodb.net/?retryWrites=true&w=majority",{useNewUrlParser:true,useUnifiedTopology:true}).then((result)=>{
    if (result) {
        app.listen(port,()=>{
